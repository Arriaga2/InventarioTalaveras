...
<html lang="en">
  <head>
    ...
    <title>Talaveras Martinez</title>
...
<h4><a href="./" style="color: white;">Talaveras<b>Martinez</b></a></h4>
...
-->
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
      ...
      <footer class="footer">
        <div><a href="https://www.instagram.com/arriaga028/">Arriaga028 </a> ©</div>
        <div class="ms-auto">Version <b>1</b></div> 
      </footer>
    </div>
    <?php endif; ?>
